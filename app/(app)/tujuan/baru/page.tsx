...
const categories = [
  { value: "merah", label: "Karier", emoji: "🔴", color: "bg-uno-red", textColor: "text-white" },
  { value: "biru", label: "Growth", emoji: "🔵", color: "bg-uno-blue", textColor: "text-white" },
  { value: "hijau", label: "Kesehatan", emoji: "🟢", color: "bg-uno-green", textColor: "text-white" },
  { value: "kuning", label: "Petualangan", emoji: "🟡", color: "bg-uno-yellow", textColor: "text-ink" },
];
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-2">
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white rounded-xl font-body text-sm text-ink placeholder:text-ink-muted/50 outline-none focus:ring-2 focus:ring-block-purple/20 border border-cream-dark"
                />
                {steps.length > 1 && (
                  <button
                    onClick={() => removeStep(i)}
                    className="w-8 h-8 flex items-center justify-center text-ink-muted hover:text-uno-red transition-colors shrink-0"
                  >
          ...
          <motion.button
            onClick={addStep}
            className="flex items-center gap-2 text-block-purple font-body text-sm hover:underline py-2"
            whileTap={{ scale: 0.97 }}
          >
      ...
      >
        <motion.button
          ...
          disabled={!isValid}
          className={`w-full btn-primary btn-primary--purple disabled:opacity-40 disabled:cursor-not-allowed ${
        ...
        {showPreview && (
          ...
          >
            <motion.div
              ...
              className={`w-full max-w-sm ${selectedCategory?.color || "bg-block-purple"} rounded-3xl p-8 text-center shadow-2xl`}
            >
